...
def delete_user(user_id):
    ...
    if user:
        ...
        if messages:
            ...
            user.password = generate_password_hash('placeholder')  # reset password
...
def create_unit():
    ...
    new_unit = Units(unit_name=unit_name, tutor_id=tutor_id, timetable=timetable, enrollments=enrollments)
